...
data F a = Fun String [X] [F a] (S a) deriving(Eq, Show)
...
data S a = ExprAsS (E a) | Pris X (E a) | Write (E a) | ReadStr | While (E a) (S a) | If (E a) (S a) (S a) | Seq (S a) (S a) | Skip deriving(Eq, Show)
